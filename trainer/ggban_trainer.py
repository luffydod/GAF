...
from model.ggban import GGBan
import time
from datetime import datetime
import ipdb


class GGBanTrainer(BaseTrainer):
    ...
    def train(self):
        ...
        model_file1 = f"./ckpt/GGBan_{self.conf['dataset_name']}_epoch{epochs}_best_MinValLoss{min_loss_val_str}_{timestamp}.ckpt"
        ...
        model_file2 = f"./ckpt/GGBan_{self.conf['dataset_name']}_epoch{epochs}_final_ValLoss{epoch_val_loss_str}_{timestamp}.ckpt"

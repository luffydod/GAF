...
class MLP(nn.Module):
    def __init__(self, input_dims, output_dims, activations, use_bias=True, use_dropout=True):
...
class TemporalAttention(nn.Module):
    ...
    def forward(self, X, STE):
        ...
        if self.mask==True:
            ...
            mask = torch.ones(num_step, num_step).to(device)
